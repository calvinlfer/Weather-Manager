...
class Server extends Routes {
  ...
  val dynamoClient: AmazonDynamoDBAsyncClient = dynamoConfig.get()
  ...
  override val memberManager: MemberManager = new SimpleMemberManager(memberRepo, pwResetRepo, userShardRegion, mailer)
